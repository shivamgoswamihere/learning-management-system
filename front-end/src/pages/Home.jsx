...
const Home = () => {
  ...
  useEffect(() => {
    if (courses.length > 0) {
      const fixedCourse = courses.find((course) => course._id === "67cf1b332a880a308e68bd3c") || courses[0];
      setFeaturedCourse(fixedCourse);
  ...
  return (
    <div className="font-sans bg-white">
      ...
      <section className="py-16 px-6 md:px-16 relative flex flex-col md:flex-row items-center gap-10 max-w-6xl mx-auto">
        <div className="w-full md:w-1/2 relative">
          <img src={reviewbg} alt="Happy Student" className="w-full rounded-lg " />
        </div>
        <div className="w-full md:w-1/2 text-left">
          <h3 className="text-sm text-gray-500 uppercase">What Our Happy Students Say</h3>
          <p className="mt-3 text-2xl font-semibold text-gray-800">"Mauris auctor sit consequat sed aenean purus egestas porta vel fermentum, nec nisi at eget non, nisi tincidunt tempus."</p>
          <p className="mt-4 text-lg font-semibold text-gray-900">Elena Miles</p>
          <p className="text-gray-500">Student</p>
          <Link to="/reviews" className="mt-6 inline-block text-blue-600 font-semibold">Read All Reviews →</Link>
        </div>
      </section>
